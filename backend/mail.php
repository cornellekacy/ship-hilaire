    ...
    if ($mail->addReplyTo($_POST['email'], $_POST['name'])) {
        ...
        $mail->Body = "
                 <img src=\"cid:logoimg1\" />
                    ...
                    <br><br><br><br>
                    <P style='font-size: 11px;'>This invoice  is processed by Cargo Mover Home Service Delivery Transports and logistics, Inc. If you need more information, please contact us at contact@royallogistics.WORLD</P>
